...
from tier1.region_algebra.abstract_domains import Sign, Nullability, analyze_assignment
...
class InterproceduralFixpointAnalyzer(FixpointAnalyzer):
    ...
    def _check_null_safety(self, stmt: ast.AST, context: AnalysisContext):
        ...
        from tier1.discovery.abstract_domains import check_null_dereference
