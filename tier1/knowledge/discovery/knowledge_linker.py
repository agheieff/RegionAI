...
from tier2.computer_science.semantic.fingerprint import DocumentationQuality
from tier1.knowledge.infrastructure.hub_v1 import KnowledgeHub
from tier1.knowledge.infrastructure.world_graph import Concept, WorldKnowledgeGraph
from tier1.knowledge.discovery.bayesian_updater import BayesianUpdater
from tier2.linguistics import nlp_utils
from tier1.utils.component_loader import get_nlp_model
