...
from tier1.domain.planning import ExecutionPlan, PlanStep, PlanResult
from tier1.domain.actions import FixSuggestion, GeneratedFix
...
from tier1.actions.code_generator import CodeGenerator
...
def execute_single_step(step_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        from tier1.knowledge.infrastructure.hub_v2 import KnowledgeHubV2
        from tier1.knowledge.infrastructure.reasoning_graph import FunctionArtifact
        from tier1.domain.discoveries import Discovery
    ...
    def _process_worker_result(self, worker_result: Dict[str, Any], step: PlanStep, result: PlanResult):
        ...
        for discovery_data in worker_result['discoveries']:
            ...
            if discovery_type == 'Discovery':
                ...
                from tier1.domain.discoveries import Severity
                from tier1.knowledge.infrastructure.reasoning_graph import FunctionArtifact
