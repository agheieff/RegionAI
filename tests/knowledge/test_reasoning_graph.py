...
from regionai.knowledge.models import ReasoningConcept, Heuristic, ReasoningType
...
def test_specific_heuristics_exist():
    ...
    for name, expected_score in expected_heuristics:
        ...
        assert heuristic.utility_score == expected_score, \
            f"Heuristic '{name}' has wrong utility_score: {heuristic.utility_score} != {expected_score}"
