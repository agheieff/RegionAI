...
class TestIntegration(unittest.TestCase):
    ...
    def test_action_discoverer_initialization(self):
        ...
        from regionai.knowledge.action_discoverer import ActionDiscoverer
    ...
    def test_grammar_extractor_with_missing_model(self):
        ...
        with patch('regionai.language.grammar_extractor.get_nlp_model') as mock_get_nlp:
            mock_get_nlp.return_value = None
            
            from regionai.language.grammar_extractor import GrammarPatternExtractor
