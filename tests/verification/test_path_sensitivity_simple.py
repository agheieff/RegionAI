...
from src.regionai.analysis.fixpoint import PathSensitiveFixpointAnalyzer, AnalysisState
...
def main():
    ...
    results = []
    results.append(("Simple if-else", test_simple_if_else()))
    results.append(("Path constraint refinement", test_path_constraint_application()))
