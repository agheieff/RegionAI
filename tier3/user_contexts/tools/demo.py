...
def demo_discovery():
    ...
    from tier1.region_algebra.transformation import (
...
def demo_analysis():
    ...
    from tier2.computer_science.range_domain import Range, check_array_bounds
...
def demo_interprocedural():
    ...
    from tier2.computer_science import build_call_graph, visualize_call_graph
